	...
	public Bonus_GamePanel3(JFrame mf) {
		...
		hok1.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
			    ...
			    Point position1 = new Point(currLocation.x + 5, currLocation.y);
			    Point position2 = new Point(currLocation.x - 5, currLocation.y);
			    for (int i = 0; i < 20; i++) {
			    	mf.setLocation(position1);
			    	mf.setLocation(position2);
			    }
			    mf.setLocation(currLocation);
			    hok1.setIcon(new ImageIcon("images/bonus/hok" + imgNum + ".png"));
			  }
